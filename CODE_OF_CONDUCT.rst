...
The purpose of this Code of Conduct is to ensure a professional, lawful,
and respectful environment for collaboration related to this project.
...
* Engage in constructive, relevant, and good-faith discussion
* Respect differing viewpoints and technical decisions
* Comply with applicable local, national, and international laws

Technical disagreement is acceptable. Hostility, disruption, or abuse is not.

Prohibited conduct
------------------

The following behaviors are strictly prohibited, without exception:

* Harassment, intimidation, threats, or abusive language
* Discriminatory or hateful speech or conduct of any kind
...
* Encouraging, promoting, or justifying illegal, unethical,
  or malicious activity
* Any behavior that interferes with the safe, lawful, or intended operation of the
...
* Any public or private interaction that directly relates to the project

Enforcement
-----------

Project maintainers reserve the **exclusive and final authority** to
interpret and enforce this Code of Conduct.
...
* Reporting to GitHub or relevant authorities where appropriate

No explanation or justification for enforcement actions is required.
...
participation by any individual at any time, for any reason, or for no
stated reason, to the maximum extent permitted by applicable law.
