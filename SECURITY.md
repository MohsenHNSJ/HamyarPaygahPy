...
The security of this application is a priority.  
All security vulnerabilities must be reported **privately and responsibly**.
...
Reports must include sufficient technical detail to permit verification and assessment, including:
...
The developer reserves the sole discretion to determine whether a reported issue constitutes a security vulnerability and whether remediation is warranted.
...
Failure to comply with coordinated disclosure expectations may result in the report being ignored and may expose the reporter to legal consequences under applicable laws.
...
Any use of this application for malicious, abusive, unethical, or illegal purposes is **strictly forbidden**, falls entirely outside the intended scope of the project, and is undertaken **solely at the user’s own risk and responsibility**.
...
Reports that focus on misuse scenarios rather than demonstrable security flaws in the application itself may be rejected without response.
...
The existence of a security policy does not imply any guarantee that vulnerabilities will be discovered, reported, or resolved.

---

## Acknowledgement of Good-Faith Research

Security researchers acting in good faith, within the boundaries of this policy and applicable law, are acknowledged and appreciated. Such acknowledgment does not imply acceptance of liability, obligation, or endorsement.
